...
export default (props: any) => {
    ...
    
  {
    ...
    render: (text, record, index) => <Space>
      <Button type="text" key="1" icon={<EditOutlined />}
      onClick={(event) => {
  ...
  return <ContentWrap>
      ...
      >
        ...
        >
          <Row gutter={20}>
            ...
            <Col span={12}>
              <Form.Item label="Amount in Local Currency(CNY)" name="amountInLocalCurrencyCNY">
                <Input />
              </Form.Item>
            </Col>
    ...
    <TableList
      ...
      renderBtns={<Space>
        ...
        <BtnThemeWrap color="grass"><Button
        disabled={!selectedRowKeys.length}
        onClick={() => {
          setEditListMark(true);
        }}
        >Quick Edit</Button></BtnThemeWrap>
        ...
        <BtnThemeWrap color="blue">
          <Dropdown trigger={["click"]} overlay={() => (
            <Menu>
              <Menu.Item key="1" >
                <span style={{ margin: "0 10px" }}>Batch File-Manual</span>
              </Menu.Item>
              <Menu.Item key="2" >
        ...
        <BtnThemeWrap><Button onClick={() => setShowImport(true)}>Import</Button></BtnThemeWrap>
        <BtnThemeWrap><Button>Generate Customer Report</Button></BtnThemeWrap>
        <Divider type="vertical" style={{ height: '20px', borderColor: "#999" }} />
