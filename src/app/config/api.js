export const Api = {
  ...
  BillingIntegrityDataQuery: '/api/BillingValidateReport/IntegrityDataQuery', //
  BillingIntegrityDataExport: '/api/BillingValidateReport/IntegrityDataExport', //
  ...
  BillingDetalInPercentageConfigQuery: '/api/BillingValidateReport/DetalInPercentageConfigQuery', //
};
