export default {
  define: {
    ...
    'process.env.WEB_URL': 'http://192.168.30.237:8005',
    'process.env.BASE_URL': 'http://192.168.30.237:8003',
    'process.env.REDIRECT_URL': 'http://192.168.30.237:8005/callback.html',
    'process.env.IDENTITY': 'http://192.168.30.237:8834/',
